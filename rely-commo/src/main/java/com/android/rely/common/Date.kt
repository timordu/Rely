...
fun dateInterval(date1: String, date2: String, format: String = "yyyy-MM-dd"): Long = dateInterval(date1.parseStr2Mills(format), date2.parseStr2Mills(format))
...
fun timeInterval(time1: String, time2: String, format: String = "yyyy-MM-dd HH:mm:ss"): Long = timeInterval(time1.parseStr2Mills(format), time2.parseStr2Mills(format))
