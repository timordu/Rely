 ...
 * 将json转成Map
 */
fun <T, E> String.jsonToMap(clazz1: Class<T>, clazz2: Class<E>): Map<T, E> = Gson().fromJson(this,
    type(Map::class.java, clazz1, clazz2)
)

/**
 * 将json转成List
 */
fun <T> String.jsonToyList(clazz: Class<T>): List<T> = Gson().fromJson(this,
    type(List::class.java, clazz)
)
