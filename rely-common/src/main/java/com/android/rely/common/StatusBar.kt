...
fun Activity.smoothSwitchScreen(@ColorRes color: Int = R.color.colorPrimary) {
    ...
    //设置状态栏颜色
    rectView.setBackgroundColor(resources.getColor(color, theme))
    // 添加矩形View到布局中
    val decorView = window.decorView as ViewGroup
    decorView.addView(rectView)
    val rootView = (this.findViewById<View>(android.R.id.content) as ViewGroup).getChildAt(0) as ViewGroup
